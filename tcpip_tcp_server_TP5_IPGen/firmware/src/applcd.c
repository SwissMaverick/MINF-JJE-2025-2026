...
void APPLCD_Initialize ( void )
{
    ...
    applcdData.newDataToDisplay = false;
...
void APPLCD_Tasks ( void )
{
    ...
    switch ( applcdData.state )
    {
        ...
        case APPLCD_STATE_SERVICE_TASKS:
        {
            ...
            if(applcdData.newDataToDisplay)
            {
                applcdData.newDataToDisplay = false;
                lcd_gotoxy(1,4);
                printf_lcd("%s", applcdData.strToDisplay);
            }
            break;
        }
...
void APPLCD_Display(char* str)
{
    applcdData.newDataToDisplay = true;
    strcpy(applcdData.strToDisplay, str);
